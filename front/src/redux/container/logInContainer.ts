...
const mapDispatchToProps = (
  ...
  return {
    inputName: (inputValue: string) =>
      dispatch(userActions.inputName(inputValue)),
    inputEmail: (inputValue: string) =>
      dispatch(userActions.inputEmail(inputValue)),
    inputPassword: (inputValue: string) =>
      dispatch(userActions.inputPassword(inputValue)),
    inputPasswordConfirmed: (inputValue: string) =>
      dispatch(userActions.inputPasswordConfirmd(inputValue)),
    ...
    postSignUp: (
      ...
      password: string,
      passwordConfirmed: string
    ) => dispatch(postSignUp(name, email, password, passwordConfirmed)),
